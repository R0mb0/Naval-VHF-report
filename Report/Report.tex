 	...
 	%\raggedright
		\begin{figure}
			\begin{columns}
				\hfill
				\column{.1\linewidth}
				\animategraphics[loop,width=3\textwidth]{10}{GifImage/Wavey/Wavey-}{0}{30}
				\column{.3\linewidth}
				%\caption{{\textcolor{gray!80}{[Immagine animata]}}}
	...
	\framesubtitle{Descrizione parte 2}
		...
		\begin{column}{0.4\textwidth}
			\begin{figure}
				...
				\raggedright
				%\hfill
				\animategraphics[loop,width=0.8\textwidth]{10}{GifImage/FM/FM-}{0}{31}\\
...
\begin{frame}{Propagazione delle onde elettromagnetiche}
	...
	\begin{figure}
		\begin{columns}
			\hfill
			\column{.1\linewidth}
			\animategraphics[loop,width=2.5\textwidth]{10}{GifImage/Antenna/Antenna-}{0}{7}
			\column{.3\linewidth}
			%\caption{{\textcolor{gray!80}{[Immagine animata]}}}
			\qquad \tiny{\textcolor{gray!80}{[Immagine animata]}}
		\end{columns}
