...
\begin{frame}{Modulazione di ampiezza}
	...
	Supponiamo di utilizzare come \textbf{onda portante} (di frequenza maggiore rispetto all'onda modulante), un'onda periodica in questa forma:\\
	\smallskip
	\centering{$\vartheta_{p} (t) = V_{p} \cos \omega_{p} t$ \quad (prima figura)}\\
